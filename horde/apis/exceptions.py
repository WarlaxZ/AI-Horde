...
class ImageValidationFailed(wze.BadRequest):
    def __init__(
        self,
        message="Please ensure the source image payload for img2img is a valid base64 encoded image.",
    ):
...
class InvalidProcGen(wze.NotFound):
    def __init__(self, gen_id):
        ...
        self.log = (
            f"Worker attempted to provide generation for {gen_id} but it did not exist"
        )
