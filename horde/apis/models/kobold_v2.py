...
class Parsers(v2.Parsers):
    def __init__(self):
        ...
        self.job_pop_parser.add_argument(
            ...
            type=str,
            required=False,
            help="The model currently available on this worker",
            location="json",
        )
...
class Models(v2.Models):
    def __init__(self, api):
        ...
        self.response_model_generation_result = api.inherit(
            ...
            {
                "text": fields.String(
                    title="Generated Text", description="The generated text."
                ),
        ...
        self.root_model_generation_payload_kobold = api.model(
            "ModelPayloadRootKobold",
            {
                ...
                "max_length": fields.Integer(
                    min=16, max=512, description="Number of tokens to generate."
                ),
        ...
        self.response_model_generation_payload = api.inherit(
            ...
            self.root_model_generation_payload_kobold,
            {
                "prompt": fields.String(
                    description="The prompt which will be sent to Kobold Diffusion to generate an image"
                ),
            },
        )
        ...
        self.response_model_generations_skipped = api.inherit(
            ...
            {
                "max_content_length": fields.Integer(
                    example=0,
                    description="How many waiting requests were skipped because they demanded a higher max_content_length than what this worker provides.",
                ),
                "max_length": fields.Integer(
                    example=0,
        ...
        self.input_model_request_generation = api.model(
            ...
            {
                "prompt": fields.String(
                    description="The prompt which will be sent to KoboldAI to generate an image"
                ),
                ...
                "softprompts": fields.List(
                    fields.String(
                        description="Specify which softpompts need to be used to service this request"
                    )
                ),
                ...
                "nsfw": fields.Boolean(
                    default=False,
                    description="Set to true if this request is NSFW. This will skip workers censor text.",
                ),
                "workers": fields.List(
                    fields.String(
        ...
        self.response_model_worker_details = api.inherit(
            "WorkerDetailsKobold",
            self.response_model_worker_details,
            {
                "max_length": fields.Integer(
                    example=80,
        ...
        self.response_model_horde_performance = api.inherit(
            "HordePerformanceKobold",
            self.response_model_horde_performance,
            {
                ...
                "worker_count": fields.Integer(
                    description="How many workers are actively processing text generations in this Horde in the past 5 minutes"
                ),
            },
        )
