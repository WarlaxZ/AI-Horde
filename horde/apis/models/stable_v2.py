        ...
        self.root_model_generation_payload_stable = api.model(
            "ModelPayloadRootStable",
            {
                ...
                "toggles": fields.List(
                    ...
                    required=False,
                    example=[1, 4],
                    description="Obsolete Toggles used in the SD Webui. To be removed. Do not modify unless you know what you're doing.",
                ),
                "cfg_scale": fields.Float(
                    required=False, default=5.0, min=-40, max=30, multiple=0.5
                ),
                "denoising_strength": fields.Float(
                    required=False, example=0.75, min=0, max=1.0, multiple=0.01
                ),
                "seed": fields.String(
                    required=False,
